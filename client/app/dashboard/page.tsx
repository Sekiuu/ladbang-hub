  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-blue-50 to-cyan-50 p-4 sm:p-6 pt-24">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <div className="text-3xl font-light text-slate-700 flex flex-col sm:flex-row justify-between items-start sm:items-center">
            <h1>{Pages[currentPage].toUpperCase()}</h1>
            <ButtonUI
              onClick={() => {
          ...
          {currentPage === 0 ? (
            <div className="flex items-center gap-4">
              ...
              <select
                ...
                className="mt-1 text-slate-600 px-3 py-1 border border-sky-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-sky-300 bg-white font-light text-sm"
              >
