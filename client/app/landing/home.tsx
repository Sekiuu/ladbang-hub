...
export default function HomePage({ testData, test2Data }: { testData: ResponseData | null, test2Data: ResponseData | null }) {
    ...
    return (
        <div className="col-span-4 bg-red-500 w-full gap-5 h-full flex flex-col items-center justify-center">
            ...
            <ButtonUI onClick={() => { handleTestAPI(0) }} className="min-w-lg">Test API</ButtonUI>
            <ButtonUI onClick={() => { handleTestAPI(1) }} className="min-w-lg">Test API 2</ButtonUI>
        </div>
    );
}